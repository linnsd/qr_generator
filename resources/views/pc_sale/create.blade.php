                            ...
                            <div class="row">
                              <div class="col-md-6">
                               ...
                               <div class="form-group row">
                                ...
                                <input type="text" id="c_name" class="form-control" name="c_name" required autofocus placeholder="Mg Mg">
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                  ...
                                  <input type="number" id="c_phone" class="form-control" name="c_phone" required autofocus placeholder="09xxxxxxxxx">
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <input type="text" id="date" class="form-control" name="date" required placeholder="{{date('d-m-Y')}}">
                                    @if ($errors->has('date'))
                          ...
                          <fieldset class="form-group border p-3">
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                  ...
                                  <input type="text" id="cpu" class="form-control" name="cpu" required placeholder="Core i7 10th SN-ABCDEFG">
                                  @if ($errors->has('cpu'))
                              ...
                              <div class="col-md-6">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <input type="text" id="board" class="form-control" name="board" required placeholder="Asus H510MK SN-ABCDEFG">
                                    @if ($errors->has('board'))
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                  ...
                                  <input type="text" id="memory" class="form-control" name="memory" required placeholder="Apacer DDR4 8GB SN-ABCDEFG">
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-group row">
                                ...
                                <input type="text" id="hdd" class="form-control" name="hdd" required placeholder="HDD 1000GB SN-ABCDEFG">
                                @if ($errors->has('hdd'))
                            ...
                            <div class="row">                    
                              <div class="col-md-6">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <input type="text" id="graphic" class="form-control" name="graphic" required placeholder="Asus GT730 2GB SN-ABCDEFG">
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <input type="text" id="power_supply" class="form-control" name="power_supply" required placeholder="Green Tech 800W SN-ABCDEFG">
                              ...
                              <div class="col-md-6">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <input type="text" id="drive" class="form-control" name="drive" required placeholder="Lite On SN-ABCDEFG">
                                    @if ($errors->has('drive'))
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <input type="text" id="casing" class="form-control" name="casing" required placeholder="Deagon 1903">
